...
![discord-collaboration](./docs/planning/discord_collaboration.png)
...
![git_merge_editor](./docs/planning/git_merge_editor.png)

![git_rebase_diagram](./docs/planning/git_rebase_diagram.png)
